            ...
            <body>
                ...
                <div class="container-fluid py-5">
                    <div class="container py-5">
                                ...
                                <tbody>
                                    <c:forEach var="cartDetail" items="${cartDetails}">
                                        <tr>
                                            ...
                                            <td>
                                                <p class="mb-0 mt-4"><a href="/product/${cartDetail.product.id}">${cartDetail.product.name}</a></p>
                                            </td>
                                            <td>
                                                <p class="mb-0 mt-4">
                        ...
                        <div class="row mt-5 g-4 justify-content-start ">
                                ...
                                <div class="bg-light rounded">
                                    <div class="p-4">
                                        ...
                                        <div class="d-flex justify-content-between mb-4">
                                            ...
                                            <p class="mb-0"><fmt:formatNumber type="number"
